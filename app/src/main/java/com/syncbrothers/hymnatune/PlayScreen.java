...
public class PlayScreen extends Activity {
    ...
    private void stopPlay()
    {
        ...
        //seekBar.setProgress(0);
        picker.setValue(0);
        int durationInMs=player.getCurrentPosition();
        int durationInS=(durationInMs / 1000);
        if(durationInMs%1000!=0)
            durationInS+=1;

        if(durationInS<60){
            if(durationInS<10)
                music_duration.setText("00:0"+durationInS);
            else
            ...
            int durationInMin = (durationInS / 60);
            durationInS=durationInS%60;
            if(durationInS<10)
                music_duration.setText(" " + durationInMin + ":0" + durationInS);
            else
                music_duration.setText("00:"+durationInS);
