...
/**
 * Created by Akshay on 06-04-2016.
 */
 ...
 */
public class ChatDirectBroadcastReceiver1 extends BroadcastReceiver implements WifiP2pManager.ConnectionInfoListener, WifiP2pManager.PeerListListener {
    ...
    public ChatDirectBroadcastReceiver1(WifiP2pManager manager, WifiP2pManager.Channel channel, LocalService srv) {
        super();
