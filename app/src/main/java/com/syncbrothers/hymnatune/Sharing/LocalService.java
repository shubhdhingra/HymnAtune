...
{	
	...
	ChatDirectBroadcastReceiver1 mWifiP2PReceiver=null; //b-cast receiver
    ...
    public IBinder onBind(Intent intent)
    {
    	if (mWifiP2PReceiver==null) //if there's no active receiver
    	{
		    ...
		    mWifiP2PReceiver = new ChatDirectBroadcastReceiver1(ChatSearchScreenFrag.mManager, ChatSearchScreenFrag.mChannel, this);
